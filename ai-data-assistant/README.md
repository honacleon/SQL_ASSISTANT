...
**Sistema Multiagentes Inteligente para Análise de Dados via Linguagem Natural**

Converse com seu banco de dados em português e obtenha respostas instantâneas com queries SQL otimizadas. Sistema profissional com arquitetura de 5 agentes especializados e performance 10-50x mais rápida através de RPC functions.

## ✨ Funcionalidades Principais

### 🤖 Sistema Multiagentes (5 Agentes Especializados)

1. **Coordinator Agent** - Analisa intenção e contexto da pergunta
2. **Schema Agent** - Descobre estrutura e metadados das tabelas
3. **Query Agent** - Gera SQL otimizado e inteligente
4. **Analyst Agent** - Analisa resultados e gera insights
5. **Formatter Agent** - Formata resposta em linguagem natural

### ⚡ Performance Otimizada

- **RPC Functions** no Supabase para queries complexas
- **10-50x mais rápido** que processamento tradicional
- **Fallback inteligente**: RPC → Supabase Client → Memória
- **Cache de metadados** para reduzir latência
